          ...
          {customers.map((customer) => (
            <tr key={customer._id} className="hover:bg-gray-700 cursor-pointer">
              ...
              <td className="py-2 px-4">
                <label className={`inline-flex items-center ${!customer.isPendingApproval && customer.paidStatus ? 'bg-green-900' : ''} p-2 rounded`}>
                  <input
                    type="checkbox"
              ...
              <td className="py-2 px-4">
                <label className={`inline-flex items-center ${!customer.isPendingApproval && customer.visitStatus ? 'bg-green-900' : ''} p-2 rounded`}>
                  <input
                    type="checkbox"
